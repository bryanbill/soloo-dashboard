export const OverviewCard = () => {
  return (
    <div className="relative w-max h-52 bg-cover bg-center group rounded-lg overflow-hidden mt-4 shadow-lg transition duration-300 ease-in-out bg-gradient-to-r from-sky-500 to-indigo-500">
